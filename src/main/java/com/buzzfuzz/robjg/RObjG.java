...
import com.buzzfuzz.robjg.decisions.RNG;
import com.buzzfuzz.robjg.traversal.ClassPkg;
import com.buzzfuzz.robjg.traversal.InstanceDispatcher;
...
public class RObjG {
    ...
    public RObjG(String[] classPaths) {
        this(pathsToUrls(classPaths));
    }

    public RObjG(URL[] urls) {
        this(new URLClassLoader(urls, RObjG.class.getClass().getClassLoader()));
    }

    public RObjG(URLClassLoader child) {
    ...
    public RObjG(Reflections reflections) {
