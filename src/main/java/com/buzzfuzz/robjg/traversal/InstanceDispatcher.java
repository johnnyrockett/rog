...
import com.buzzfuzz.robjg.RObjG;
...
public class InstanceDispatcher {
    ...
    public InstanceDispatcher(RObjG robjg) {
        this(new RNG(), robjg);
    }
	
	public InstanceDispatcher(RNG rng, Set<ClassPkg> chain, RObjG robjg) {
		this.rng = rng;
        this.history = chain == null ? new LinkedHashSet<ClassPkg>() : new LinkedHashSet<ClassPkg>(chain);
        this.robjg = robjg;
    }

	public InstanceDispatcher(RNG rng, RObjG robjg) {
		this(rng, null, robjg);
	}
	...
	public InstanceDispatcher(InstanceFinder finder) {
		this(finder.rng, finder.history, finder.robjg);
	}
